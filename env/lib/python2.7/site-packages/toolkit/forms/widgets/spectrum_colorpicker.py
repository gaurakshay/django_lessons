...
class SpectrumColorPickerWidget(forms.TextInput):
    def render(self, name, value, attrs=None):
        ...
        return rendered + mark_safe(u'''<link href="//cdnjs.cloudflare.com/ajax/libs/spectrum/1.8.0/spectrum.min.css" type="text/css" img="all" rel="stylesheet"><script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/spectrum/1.8.0/spectrum.min.js"></script><script type="text/javascript">
